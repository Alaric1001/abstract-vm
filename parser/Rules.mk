...
parser/$(OBJECT_DIR)/%.o: parser/%.cpp
	$(COMP) $@ $<
parser/$(OBJECT_DIR)/Errors.o: parser/Errors.cpp parser/Errors.hpp \
...
parser/$(OBJECT_DIR)/parser.o: parser/parser.cpp parser/parser.hpp \
  lexer/Token.hpp utils/Dump.hpp utils/Stack.hpp utils/RuntimeError.hpp \
  vm/ExecActions.hpp vm/IExecElems.hpp vm/IOperand.hpp parser/Errors.hpp \
  parser/InstructionHandler.hpp parser/Handler.hpp parser/Pattern.hpp \
  utils/static_uptr_cast.hpp vm/globals.hpp
parser/parser.hpp:
vm/globals.hpp:
